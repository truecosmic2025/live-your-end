...
export const CTAButton = ({ 
  ...
  const variants = {
    primary: "bg-primary text-primary-foreground hover:bg-primary/90 cosmic-glow-hover px-4 sm:px-6 md:px-8 py-4 md:py-6 text-sm sm:text-base md:text-lg font-semibold rounded-xl font-bold",
